  ...
  return (
    <div className="relative py-20 flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('/members-bg.jpg')] bg-cover bg-center opacity-30 mix-blend-luminosity"></div>
      ...
      <div className="container mx-auto px-4 z-10 py-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="block text-white">Les Membres de</span>
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8">
            Découvrez les aventuriers qui composent notre compagnie libre. Chaque membre apporte son histoire, ses compétences et sa personnalité unique à notre communauté d'Éorzéa.
          </p>
